...
import { validateGetDashboardStats } from './dashboard.validator.js';
 ...
 */
fastify.get('/stats', { preHandler: [validateGetDashboardStats] }, getDashboardStatsHandler);
 ...
 */
fastify.get('/search', fetchDashboardSearch);
