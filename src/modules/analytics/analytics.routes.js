 ...
 */
fastify.get('/trends', { preHandler: [validateQuery(getTrendsSchema)] }, fetchTrends);
 ...
 */
fastify.get('/journals/impact-matrix', { preHandler: [validateQuery(getImpactMatrixSchema)] }, fetchImpactMatrix);
 ...
 */fastify.get('/frontier', { preHandler: [validateQuery(getFrontierSchema)] }, fetchFrontier);
 ...
 */
fastify.get('/distribution', { preHandler: [validateQuery(getDistributionSchema)] }, fetchDistribution);
 ...
 *                   example: null
 */
fastify.get('/forecast', { preHandler: [validateQuery(getForecastSchema)] }, fetchForecast);
 ...
 *                         type: number
 *                         example: 94.2
 */fastify.get('/top-entities', { preHandler: [validateQuery(getTopEntitiesSchema)] }, getTopEntitiesHandler);
 ...
 *         description: Project not found
 */
fastify.get('/geo-distribution', { preHandler: [validateQuery(getGeoDistributionSchema)] }, fetchGeoDistribution);
 ...
 *                             type: number
 *                             example: 42
 */fastify.get('/journals/quartiles', { preHandler: [validateQuery(getJournalQuartileSchema)] }, fetchJournalQuartileDistribution);
 ...
 *                           example: 100
 */
fastify.get('/journals/ranking', { preHandler: [validateQuery(getJournalRankingSchema)] }, fetchJournalRanking);
 ...
 *         description: Project not found
 */
fastify.get('/network/collaboration', { preHandler: [validateQuery(getCollaborationNetworkSchema)] }, fetchCollaborationNetwork);
 ...
 *         description: Project not found
 */
fastify.get('/rankings', { preHandler: [validateQuery(getRankingsSchema)] }, fetchRankings);
 ...
 *         description: Project not found
 */
fastify.get('/matrix/productivity', { preHandler: [validateQuery(getProductivityMatrixSchema)] }, fetchProductivityMatrix);
 ...
 *         description: Project not found.
 */
fastify.get('/network/chord', { preHandler: [validateQuery(getCountryCollaborationChordSchema)] }, fetchCountryCollaborationChord);
 ...
 *         description: Project not found.
 */
fastify.get('/journals/migration', { preHandler: [validateQuery(getJournalMigrationSchema)] }, fetchJournalMigration);
 ...
 */
fastify.get('/network/topology', { preHandler: [validateQuery(getNetworkTopologySchema)] }, fetchNetworkTopology);
 ...
 *         description: Project not found
 */
fastify.get('/keywords/vectors', fetchKeywordVectors);
 ...
 *         description: Project not found
 */
fastify.get('/matrix/intensity', fetchTopicIntensityMatrix);
 ...
 */
fastify.get('/development-trends', { preHandler: [validateQuery(getDevelopmentTrendsSchema)] }, fetchDevelopmentTrends);
 ...
 *                       example: Random walk
 */
fastify.get('/network/collab-insights', { preHandler: [validateQuery(getCollaborationInsightsSchema)] }, fetchCollaborationInsights);
 ...
 *         description: Success
 */
fastify.get('/network/collab-metrics', { preHandler: [validateQuery(getCollaborationInsightsSchema)] }, fetchCollaborationMetrics);
 ...
 */
fastify.get('/network/collab-report/export', { preHandler: [validateQuery(getCollaborationInsightsSchema)] }, exportCollaborationReport);
 ...
 *               type: string
 */
fastify.get('/network/chord/export', { preHandler: [validateQuery(getCountryCollaborationChordSchema)] }, exportCountryCollaborationMatrix);
 ...
 */
fastify.get('/network/cross-links', { preHandler: [validateQuery(getCrossLinksSchema)] }, fetchCrossLinks);
 ...
 */
fastify.get('/network/temporal-shift', { preHandler: [validateQuery(getTemporalShiftSchema)] }, fetchTemporalShift);
 ...
 *         description: Project not found
 */
fastify.get('/curated-articles', { preHandler: [validateQuery(getCuratedArticlesSchema)] }, fetchCuratedArticles);
 ...
 *                         type: string
 */
fastify.get('/project-keywords', { preHandler: [validateQuery(getProjectKeywordsSchema)] }, fetchProjectKeywords);
fastify.post('/project-keywords', { preHandler: [validateQuery(getProjectKeywordsSchema)] }, addProjectKeywordHandler);
fastify.delete('/project-keywords/:keyword_id', { preHandler: [validateQuery(getProjectKeywordsSchema)] }, removeProjectKeywordHandler);
