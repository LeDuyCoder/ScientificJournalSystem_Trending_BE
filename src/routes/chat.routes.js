 ...
 *                   example: 10
 */
router.post('/projects/:projectId/chat/messages', requireAuth, createChatMessageHandler);
router.get('/projects/:projectId/chat/messages', requireAuth, getChatHistory);
router.delete('/projects/:projectId/chat/messages', requireAuth, clearChatHistory);
 ...
 *                   example: 1
 */
router.get('/projects/:projectId/chat/messages/:messageId', requireAuth, getChatMessageDetail);
router.patch('/projects/:projectId/chat/messages/:messageId', requireAuth, updateChatMessageHandler);
router.delete('/projects/:projectId/chat/messages/:messageId', requireAuth, deleteChatMessageHandler);
